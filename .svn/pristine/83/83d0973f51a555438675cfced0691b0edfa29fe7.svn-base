 ...
 * @version V1.0
 */
public class LXH_PreferenceConfig implements LXH_IConfig
{
	private static LXH_IConfig mPreferenceConfig;
	...
	private LXH_PreferenceConfig(Context context)
	{
	 ...
	 * @return
	 */
	public static LXH_IConfig getPreferenceConfig(Context context)
	{
		if (mPreferenceConfig == null)
		{
			mPreferenceConfig = new LXH_PreferenceConfig(context);
		}
