...
public class AbListViewFooter extends LinearLayout {
	...
	private void initView(Context context) {
		...
		circularProgress = new CircularProgress(context, null,
				android.R.attr.progressBarStyle);
		...
		footerView.addView(circularProgress, layoutParamsWW);
	...
	public void setHeaderCirculaProgressColor(int color1, int color2, int color3, int color4){
		circularProgress.setColors(color1, color2, color3, color4);
	}
