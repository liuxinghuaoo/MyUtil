 ...
 */
package com.lxh.util.db.database;

import java.util.HashMap;
import java.util.Map.Entry;


import com.lxh.util.db.DB;
import com.lxh.util.db.database.utils.ManyToOne;
import com.lxh.util.db.database.utils.OneToMany;
import com.lxh.util.db.database.utils.Property;
...
public class CursorHelper {
     ...
     * @return
     */
    public static <T> T getEntity(Cursor cursor, Class<T> clazz, DB db) {
        try {
            if (cursor != null) {
                // 读取表信息
