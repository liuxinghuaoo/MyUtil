...
public class LXH_HttpResponseHandler {
	...
	public LXH_HttpResponseHandler() {
		if (Looper.myLooper() != null) {
			handler = new Handler() {
				@Override
				public void handleMessage(Message msg) {
					LXH_HttpResponseHandler.this.handleMessage(msg);
				}
			};
		}
	}

	public void onInit(String url,String name) {
//		LXH_SQLiteDatabase sqLiteDatabase=LXH_Application.getApplication().getSQLiteDatabasePool().getSQLiteDatabase();
////		List lt = sqLiteDatabase.getTables();
//		List lt=sqLiteDatabase.query(LXH_CacheEntity.class,false, "key='"+url+"'", null, null, null, null);
//		System.out.println("");
