...
import com.lxh.util.utils.ViewUtil;
 ...
 */
public class RefreshDialogFragment extends LXHDialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		parent.setMinimumWidth(ViewUtil.scale(this.getActivity(), 400));
