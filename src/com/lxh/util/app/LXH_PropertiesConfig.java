...
public class LXH_PropertiesConfig implements LXH_IConfig
{
	 ...
	 * @return
	 */
	public static LXH_PropertiesConfig getPropertiesConfig(Context context)
	{
		if (mPropertiesConfig == null)
		{
			mPropertiesConfig = new LXH_PropertiesConfig(context);
		}
	...
	public void loadConfig()
	{
		...
		InputStream in = LXH_PropertiesConfig.class
	...
	public void setConfig(Object entity)
	{
		...
		for (Field field : fields)
		{
			...
			if (!LXH_ReflectUtils.isTransient(field))
			{
				if (LXH_ReflectUtils.isBaseDateType(field))
				{
					String columnName = LXH_ReflectUtils.getFieldName(field);
