 ...
 */
@TargetApi(Build.VERSION_CODES.HONEYCOMB) @SuppressLint("NewApi") public class AlertDialogFragment extends DialogFragment {
	...
	/**确认按钮字*/
	public static String yse= "确定";
	/**取消按钮字*/
	public static String no ="取消";
	/**
	 * Create a new instance of AbDialogFragment.
	 */
	@SuppressLint("NewApi") public static AlertDialogFragment newInstance(int icon,String title,String message,View view,AbDialogOnClickListener onClickListener) {
