 ...
 * Original file: /Users/arthur/Documents/workspace/MyUtil/src/com/lxh/util/download/IDownloadService.aidl
 */
package com.lxh.util.download;
public interface IDownloadService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.lxh.util.download.IDownloadService
{
private static final java.lang.String DESCRIPTOR = "com.lxh.util.download.IDownloadService";
...
/**
 * Cast an IBinder object into an com.lxh.util.download.IDownloadService interface,
 * generating a proxy if needed.
 */
public static com.lxh.util.download.IDownloadService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.lxh.util.download.IDownloadService))) {
return ((com.lxh.util.download.IDownloadService)iin);
}
return new com.lxh.util.download.IDownloadService.Stub.Proxy(obj);
}
...
private static class Proxy implements com.lxh.util.download.IDownloadService
{
